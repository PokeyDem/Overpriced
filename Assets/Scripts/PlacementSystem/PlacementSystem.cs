        ...
        foreach (DisplayData data in displayData){
            ...
            if (itemsId.Count > 1){
                ...
                for (int i = 0; i < displaySlotControllers.Length; i++){
                    if (itemsId[i] != -1) 
                        displaySlotControllers[i].PlaceItem(_itemsDatabase._itemsData[itemsId[i]].Prefab, itemsId[i]);
                }
                ...
                if (itemsId[0] != -1) 
                    displaySlotControllers[0].PlaceItem(_itemsDatabase._itemsData[itemsId[0]].Prefab, itemsId[0]);
            }
